...
namespace UruguayBusWeb.Helpers
{
    public class EmailHelper
    {
        ...
        public void EnviarPasajeReservado(Usuario u, Pasaje p)
        {
            try
            {
                string emailHtml = "<html><head></head><body><p>¡Hola " + u.persona.nombre + "!</p>Este es mi primer correo transaccional enviado con Sendinblue desde C#.</p></body></html>";
                ...
                email.attachment.Add(
                    ...
                    {
                        name = "ArchivoAdjuntoMedianteBase64.png",
